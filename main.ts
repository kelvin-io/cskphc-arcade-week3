...
sprites.onOverlap(SpriteKind.x, SpriteKind.Enemy, function (sprite, otherSprite) {
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    projectile = sprites.createProjectileFromSprite(img`
        ...
        . . . . . . . 5 5 . . . . . . . 
        `, player_, 0, -50)
    projectile.setKind(SpriteKind.x)
})
...
game.onUpdateInterval(500, function () {
    enemy_ = sprites.createProjectileFromSide(img`
        ...
        . . . . . c c c c c c . . . . . 
        `, 0, 50)
    enemy_.x = randint(20, 140)
    enemy_.y = 0
    enemy_.setKind(SpriteKind.Enemy)
})
